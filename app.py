...
st.title(":traffic_light: Penindakan Pelanggaran Lalu Lintas dan Angkutan Jalan Tahun 2021")
st.subheader(
    "by : Irfan Amin - 1900018269 - UAS - VISDATA - C")
st.markdown("#")
...
fig_pelanggaran_lalu_lintas = px.bar(
    ...
    len(data_penindakan_pelanggaran_lalu_lintas),
    template="plotly_white",
)
...
# ================================================================================
st.subheader(
    "Grafik Garis Berdasarkan Kriteria BAP Tilang, Penderekan dan Stop Operasi")
